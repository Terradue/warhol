    ...
    extends RuntimeException
{
    ...
    /**
     * Create a new {@link TransferException} instance from the error message text.
     *
     * @param messagePattern The error message text pattern
     * @param arguments Arguments referenced by the format specifiers in the format string
     */
    public TransferException( String messagePattern, Object... arguments )
    {
        super( format( messagePattern, arguments ) );
    }

    /**
     * Create a new {@link TransferException} instance from the error message text and the related cause.
     *
